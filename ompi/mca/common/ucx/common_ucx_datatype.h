...
ucp_datatype_t mca_common_ucx_init_datatype(mca_common_ucx_datatype_ctx_t *ctx,
                                            ompi_datatype_t *datatype);
...
static inline ucp_datatype_t mca_common_ucx_get_datatype(mca_common_ucx_datatype_ctx_t *ctx,
                                                         ompi_datatype_t *datatype)
{
#ifdef HAVE_UCP_REQUEST_PARAM_T
    ...
    return mca_common_ucx_init_datatype(ctx, datatype);
}

#ifdef HAVE_UCP_REQUEST_PARAM_T
__opal_attribute_always_inline__
static inline mca_common_ucx_datatype_t*
mca_common_ucx_get_op_data(mca_common_ucx_datatype_ctx_t *ctx,
                           ompi_datatype_t *datatype)
{
    mca_common_ucx_datatype_t *ucp_type = (mca_common_ucx_datatype_t*)datatype->pml_data;
    ...
    mca_common_ucx_init_datatype(ctx, datatype);

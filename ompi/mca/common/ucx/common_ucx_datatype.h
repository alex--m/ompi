...
mca_common_ucx_from_ompi_datatype(ompi_datatype_t *datatype)
{
#ifdef HAVE_UCP_REQUEST_PARAM_T
    return ((mca_common_ucx_datatype_t*)datatype->pml_data)->datatype;
#else
...
{
    if (OPAL_UNLIKELY(datatype->pml_data == COMMON_UCX_DATATYPE_INVALID)) {

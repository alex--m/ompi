 ...
 */
static int
mca_coll_yhccl_neighbor_alltoall_cart(const void *sbuf, size_t scount, struct ompi_datatype_t *sdtype, void *rbuf,
...
static int
mca_coll_yhccl_neighbor_alltoall_graph(const void *sbuf, size_t scount, struct ompi_datatype_t *sdtype, void *rbuf,
                                       size_t rcount, struct ompi_datatype_t *rdtype, struct ompi_communicator_t *comm,
                                       mca_coll_base_module_t *module)
{
...
static int
mca_coll_yhccl_neighbor_alltoall_dist_graph(const void *sbuf, size_t scount,struct ompi_datatype_t *sdtype, void *rbuf,
                                            size_t rcount, struct ompi_datatype_t *rdtype, struct ompi_communicator_t *comm,
                                            mca_coll_base_module_t *module)
{

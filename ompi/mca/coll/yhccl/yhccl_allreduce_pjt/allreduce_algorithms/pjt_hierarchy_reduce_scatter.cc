...
//     void ring_reduce_scatter_inplace(void *sendbuf, size_t count, MPI_Comm comm, int rank, int procn, vector<int> &local_to_inter_node)
//     {
...
//     void *RA_recvbuf;
//     int RA_i;
//     void iphring_allgather(void *sendb, size_t count, MPI_Comm mcomm, int mrank, int procn)
//     {
...
//     void init(const void *datasend, void *datarecv, volatile void *shmbuf, size_t count, int elem_sz, MPI_Datatype mpitype, MPI_Op mpi_op, yhccl_op fp)
//     {
//         // addr_shift = 0;
//         //用户规约信息
...
// int pjt_WARF_allreduce(const void *datasend, void *datarecv, size_t count, int elem_sz, MPI_Datatype mpitype, MPI_Op mpi_op, yhccl_op fp)

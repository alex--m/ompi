...
int
mca_coll_yhccl_bcast_test(void *buff, size_t count,
 ...
 */
int
mca_coll_yhccl_bcast_log_intra(void *buff, size_t count,
                               struct ompi_datatype_t *datatype, int root,
                               struct ompi_communicator_t *comm,
                               mca_coll_base_module_t *module)
{
 ...
 */
int
mca_coll_yhccl_bcast_lin_inter(void *buff, size_t count,
                               struct ompi_datatype_t *datatype, int root,
                               struct ompi_communicator_t *comm,
                               mca_coll_base_module_t *module)
{
 ...
 */
int
mca_coll_yhccl_bcast_log_inter(void *buff, size_t count,
                               struct ompi_datatype_t *datatype, int root,
                               struct ompi_communicator_t *comm,
                               mca_coll_base_module_t *module)
{

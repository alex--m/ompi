...
#define SPIN_CONDITION(cond)                          \
  do {                                                \
     ...
     */
    OMPI_DECLSPEC extern mca_coll_smdirect_component_t mca_coll_smdirect_component;
    ...
    int mca_coll_smdirect_allgather_intra(const void *sbuf, size_t scount,
    ...
    int mca_coll_smdirect_allgatherv_intra(const void *sbuf, int scount,
            ...
            struct ompi_communicator_t *comm,
            mca_coll_base_module_t *module);
    int mca_coll_smdirect_allreduce_intra(const void *sbuf, void *rbuf, size_t count,
            struct ompi_datatype_t *dtype,
            struct ompi_op_t *op,
            struct ompi_communicator_t *comm,
            mca_coll_base_module_t *module);
    int mca_coll_smdirect_alltoall_intra(const void *sbuf, size_t scount,
            struct ompi_datatype_t *sdtype,
            void* rbuf, size_t rcount,
            struct ompi_datatype_t *rdtype,
            struct ompi_communicator_t *comm,
    ...
    int mca_coll_smdirect_barrier_intra(struct ompi_communicator_t *comm,
            mca_coll_base_module_t *module);
    int mca_coll_smdirect_bcast_intra(void *buff, size_t count,
            struct ompi_datatype_t *datatype,
            int root,
            struct ompi_communicator_t *comm,
            mca_coll_base_module_t *module);
    int mca_coll_smdirect_bcast_log_intra(void *buff, size_t count,
            struct ompi_datatype_t *datatype,
            int root,
            struct ompi_communicator_t *comm,
            mca_coll_base_module_t *module);
    int mca_coll_smdirect_exscan_intra(const void *sbuf, void *rbuf, size_t count,
            struct ompi_datatype_t *dtype,
            struct ompi_op_t *op,
            struct ompi_communicator_t *comm,
            mca_coll_base_module_t *module);
    int mca_coll_smdirect_gather_intra(void *sbuf, size_t scount,
    ...
    int mca_coll_smdirect_gatherv_intra(void *sbuf, int scount,
            ...
            struct ompi_communicator_t *comm,
            mca_coll_base_module_t *module);
    int mca_coll_smdirect_reduce_intra(const void *sbuf, void* rbuf, size_t count,
            struct ompi_datatype_t *dtype,
            struct ompi_op_t *op,
            int root,
            struct ompi_communicator_t *comm,
            mca_coll_base_module_t *module);
    int mca_coll_smdirect_reduce_log_intra(const void *sbuf, void* rbuf, size_t count,
            struct ompi_datatype_t *dtype,
            struct ompi_op_t *op,
            int root,
            struct ompi_communicator_t *comm,
    ...
    int mca_coll_smdirect_reduce_scatter_intra(const void *sbuf, void *rbuf,
            ...
            struct ompi_communicator_t *comm,
            mca_coll_base_module_t *module);
    int mca_coll_smdirect_scan_intra(const void *sbuf, void *rbuf, size_t count,
            struct ompi_datatype_t *dtype,
            struct ompi_op_t *op,
            struct ompi_communicator_t *comm,
            mca_coll_base_module_t *module);
    int mca_coll_smdirect_scatter_intra(const void *sbuf, size_t scount,
            struct ompi_datatype_t *sdtype, void *rbuf,
            size_t rcount, struct ompi_datatype_t *rdtype,
            int root, struct ompi_communicator_t *comm,
            mca_coll_base_module_t *module);

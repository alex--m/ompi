...
#ifndef MCA_SCOLL_UCX_H
#define MCA_SCOLL_UCX_H
...
struct mca_scoll_ucx_component_t {
    /** Base coll component */
...
typedef struct mca_scoll_ucx_component_t mca_scoll_ucx_component_t;

OMPI_MODULE_DECLSPEC extern mca_scoll_ucx_component_t mca_scoll_ucx_component;


/**
 * MPI enabled communicator
 */
struct mca_scoll_ucx_module_t {
...
typedef struct mca_scoll_ucx_module_t mca_scoll_ucx_module_t;

OBJ_CLASS_DECLARATION(mca_scoll_ucx_module_t);


/* API functions */
int mca_scoll_ucx_init_query(bool enable_progress_threads, bool enable_mpi_threads);

mca_scoll_base_module_t* mca_scoll_ucx_comm_query(oshmem_group_t *osh_group, int *priority);
...
int mca_scoll_ucx_collect(struct oshmem_group_t *group,
                          void *target,
                          const void *source,
                          size_t nlong,
                          long *pSync,

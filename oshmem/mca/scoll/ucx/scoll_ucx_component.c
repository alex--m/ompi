...
/*
 * Public string showing the oshmem scoll_ucx component version number
 */
const char *mca_scoll_ucx_component_version_string =
  "OpenSHMEM UCX collective MCA component version " OSHMEM_VERSION;


static int ucx_open(void);
static int ucx_close(void);
static int ucx_register(void);
int mca_scoll_ucx_output = -1;
mca_scoll_ucx_component_t mca_scoll_ucx_component = {
       ...
       about the component itfca */
    {
        ...
        .scoll_init = mca_scoll_ucx_init_query,
        .scoll_query = mca_scoll_ucx_comm_query,
    },
    78, /* priority */
    0,  /* verbose level */
    1,  /* ucx_enable */
        ...
        int default_value, int *storage, int flags)
{
    ...
    *storage = default_value;
    index = mca_base_component_var_register(
            &mca_scoll_ucx_component.super.scoll_version,
...
#define CHECK(expr) do {                        \
    ...
    CHECK(reg_int("np", NULL,
                  ...
                  mca_scoll_ucx_component.ucx_np,
                  &mca_scoll_ucx_component.ucx_np,
                  0));
...
static int ucx_open(void)
{
    ...
    mca_scoll_ucx_output = opal_output_open(NULL);
    opal_output_set_verbosity(mca_scoll_ucx_output, cm->ucx_verbose);
    return OSHMEM_SUCCESS;
}
